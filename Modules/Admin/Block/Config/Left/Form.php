 ...
 * Time: 14:45
 */
class Admin_Block_Config_Left_Form extends Core_Block_Abstract
{
...
//        var_dump(Core_Model_Mongo::selectAll('config')->toArray());die;
    ...
    {
        /** @var Admin_Block_Config_Left_Form_Element $element */
        $element = $this->getChunk(null, 'Admin_Block_Config_Left_Form_Element');
        $element
            ->setData('type', $type)
            ->setData('id', $id)
